...
/**
 * Конфигурация Kafka для Transfer сервиса.
 * 
 * Внимание: Transfer сервис только отправляет сообщения в Kafka (producer).
...
public class KafkaConfig {
     ...
     */
    @Bean
    public ProducerFactory<String, TransferNotificationEvent> producerFactory() {
     ...
     */
    @Bean
    public KafkaTemplate<String, TransferNotificationEvent> kafkaTemplate() {
